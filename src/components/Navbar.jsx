  ...
  <Dropdown>
    <Dropdown.Trigger>
      <div className="flex items-center gap-2 cursor-pointer">
        ...
        {/* NO PROFILE PIC (as you requested) */}
    ...
    <Dropdown.Popover>
      ...
      {/* ---------------- MOBILE MENU ---------------- */}
      {isMenuOpen && (
        <div className="lg:hidden border-t bg-white p-4 flex flex-col gap-3">

          <Link href="/" onClick={() => setIsMenuOpen(false)} className="flex items-center gap-2">
            <FaHome /> Home
          </Link>

          <Link href="/allProducts" onClick={() => setIsMenuOpen(false)} className="flex items-center gap-2">
            <FaBoxes /> Products
          </Link>

          <Link href="/categories" onClick={() => setIsMenuOpen(false)} className="flex items-center gap-2">
            <FaFolderOpen /> Categories
          </Link>
