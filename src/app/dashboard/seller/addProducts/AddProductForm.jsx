            ...
            >
              ...
              <Select.Popover className="bg-white border border-slate-100 rounded-xl shadow-xl p-1 z-50">
                <ListBox className="p-1 flex flex-col gap-0.5">
                  ...
                  <ListBox.Item id="instruments" textValue="Musical Instruments" className="p-2 text-sm text-[#22577A] rounded-lg hover:bg-slate-50 cursor-pointer">
                    Musical Instruments <ListBox.ItemIndicator />
                  </ListBox.Item>
                </ListBox>
              </Select.Popover>
            </Select>
